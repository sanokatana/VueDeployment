    ...
    <form ref="form">
      <div class="formgrid grid">
        ...
        <div class="field col-12 md:col-12 ">
          ...
          <h3
            class="flex flex-wrap justify-content-center text-base text-color surface-overlay surface-border border-round appearance-none outline-none focus:border-primary w-full">
            Nama Saudara/Orang lain yang tinggal bersama (Optional)</h3>
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        </div>
        <div class="field col-12 md:col-6">
          <h3
        ...
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.saudara"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.status4"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.saudara1"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.status1"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.saudara2"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.status2"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.saudara3"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
          <InputText v-model="formCopy.attributes.status3"
            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-12 ">
          -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        <div class="field col-12 md:col-6">
          <label>Nama Pemilik Rumah (Jika Sewa):</label>
        ...
        <div class="field col-12 md:col-6">
          ...
          <Calendar v-model="formCopy.attributes.tglMasuk" showButtonBar showIcon dateFormat="yy-mm-dd"
            class="text-base text-color surface-overlay surface-border border-round appearance-none outline-none focus:border-primary w-full" />
        </div>
        <div class="field col-12 md:col-6">
...
import pdfForm from '@/assets/pdf/DataBaruMazenta.pdf'
import pdfFormBanara from '@/assets/pdf/DataBaruBanara.pdf'
import pdfFormNaraya from '@/assets/pdf/DataBaruNaraya.pdf'
  ...
  methods: {
    ...
    async fillForm() {
      try {
        ...
        //Alamat Divide to 3 Form Fields
        ...
        formPdf.getTextField('tempattgl').setText(this.formCopy.attributes.tempat + ' - ' + this.changeDateFormat(this.formCopy.attributes.tglLahir))
        ...
        formPdf.getTextField('tglMasuk').setText(this.changeDateFormat(this.formCopy.attributes.tglMasuk ?? ''))
        formPdf.getTextField('namaadmin').setText(this.formCopy.attributes.namaadmin ?? '')
        formPdf.getTextField('saudara').setText(this.formCopy.attributes.saudara ?? '')
        formPdf.getTextField('saudara1').setText(this.formCopy.attributes.saudara1 ?? '')
        formPdf.getTextField('saudara2').setText(this.formCopy.attributes.saudara2 ?? '')
        formPdf.getTextField('saudara3').setText(this.formCopy.attributes.saudara3 ?? '')
        formPdf.getTextField('status').setText(this.formCopy.attributes.status4 ?? '')
        formPdf.getTextField('status1').setText(this.formCopy.attributes.status1 ?? '')
        formPdf.getTextField('status2').setText(this.formCopy.attributes.status2 ?? '')
        formPdf.getTextField('status3').setText(this.formCopy.attributes.status3 ?? '')
    ...
    async handleSubmit() {
      ...
      try {
        ...
        res = (await backend.dataBaruForm.updateByID(idForm, requestData));
        this.handleClose();
        this.refreshList();
        console.log(res);
