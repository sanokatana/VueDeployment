<template>
  <div class="col-12 offset-10">
    <div class="flex justify-content-between align-items-center">
      <h1 class="text-ggi-red">Panel Form - Surat Pernyataan Warga Pengerjaan Renovasi</h1>
    </div>
...
import formModal from '@/components/modal/CreatePernyataanForm.vue';
...
export default {
  ...
  methods: {
    ...
    async getAllForms() {
      try {
        let response = await backend.suratPForm.findAll();
