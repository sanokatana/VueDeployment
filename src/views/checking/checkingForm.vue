<template>
  <div class="col-12 offset-10">
    <div class="flex justify-content-between align-items-center">
      <h1 class="text-ggi-red">Panel Form - Formulir Jadwal Pengecekan Akhir Pembangunan / Renovasi</h1>
    </div>
    ...
    <DataTable :value="formData" v-model:selection="selectedForm" selectionMode="single" @row-select="showModal('edit')"
      ...
      <Column field="attributes.name" header="Nama Pemilik" :showFilterMenu="false">
      </Column>
      <Column field="attributes.cluster" header="Cluster" :showFilterMenu="false">
      </Column>
      <Column field="attributes.blok" header="Blok / No. Unit" :showFilterMenu="false">
      </Column>
      <Column field="attributes.luastanah" header="Luas Tanah / Bangunan" :showFilterMenu="false">
      </Column>
...
import formModal from '@/components/modal/CreateJPAPForm.vue';
...
export default {
  ...
  methods: {
    ...
    async getAllForms() {
      try {
        let response = await backend.jpapForm.findAll();
