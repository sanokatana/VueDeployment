<template>
  <div class="col-12 offset-10">
    <div class="flex justify-content-between align-items-center">
      <h1 class="text-ggi-red">Panel Form - Permohonan Penambahan Daya Listrik</h1>
    </div>
    ...
    <DataTable ref="dt" :filters="filters" :value="formData" selectionMode="single" @row-select="showModal('edit', $event.data)"
      ...
      <Column field="attributes.namapemilik" header="Nama Pemilik">
      </Column>
      <Column field="attributes.unitlantaiblok" header="Lantai-Blok-NoUnit">
      </Column>
      <Column field="attributes.brand" header="Brand">
      </Column>
...
import formModal from '@/components/modal/Marchand/CreateDayaForm.vue';
...
export default {
  ...
  methods: {
    ...
    async getAllForms() {
      try {
          let response = await backend.dayaMarchand.findAll();
