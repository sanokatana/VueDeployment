<template>
  <div class="col-12 offset-10">
    <div class="flex justify-content-between align-items-center">
      <h1 class="text-ggi-red">Panel Form - Surat Permohonan Izin Kerja</h1>
    </div>
    ...
    <DataTable ref="formModal" :value="formData" v-model:selection="selectedForm" selectionMode="single" @row-select="handleRowSelect"
      ...
      <Column field="attributes.nounit" header="No.Unit" :showFilterMenu="false">
      </Column>
      <Column field="attributes.pekerjaan" header="Pekerjaan" :showFilterMenu="false">
      </Column>
      <Column field="attributes.kontraktor" header="Nama Kontraktor" :showFilterMenu="false">
      </Column>
...
import formModal from '@/components/modal/Marchand/CreateKerjaForm.vue';
...
export default {
  ...
  methods: {
    async getAllForms() {
      try {
        let response = await backend.izinMarchand.findAll();
