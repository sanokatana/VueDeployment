<template>
  <div class="col-12 offset-10">
    <div class="flex justify-content-between align-items-center">
      <h1 class="text-ggi-red">Panel Form - Data Pemilik / Penghuni / Warga Pindah</h1>
    </div>
...
import formModal from '@/components/modal/CreatePindahForm.vue';
...
export default {
  ...
  methods: {
    ...
    async getAllForms() {
      try {
        let response = await backend.dataPindahForm.findAll();
    ...
    exportCSV() {
      ...
      const headerLabelMapping = {
        ...
        'alamatrumah': 'Alamat Rumah Tujuan',
        'tglPindah': 'Tanggal Pindah',
      };

      // Header row with desired labels
      const headers = ['id', 'namalengkap', 'alamat', 'pekerjaan', 'tempat', 'tglLahir', 'notelp', 'email', 'suami', 'tglLahir1', 'istri', 'tglLahir2', 'anak', 'tglLahir3', 'anak1', 'tglLahir4', 'anak2', 'tglLahir5', 'anak3', 'tglLahir6', 'namapemilik', 'alamatrumah', 'tglPindah'];
      ...
      link.download = 'Form Data Pemilik/Penghuni/Warga Pindah Mazenta.csv';
      link.click();
    },
